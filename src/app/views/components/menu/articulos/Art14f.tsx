...
export const Art14f = () => {
  ...
  const columnsArticulo14f1: GridColDef[] = [
    ...
    { field: "ProporcionRecaudacion",       headerName: "Proporción De Recaudación",                        width: 200, description: "P=RP/BG" },
    ...
    { field: "A1_1",                        headerName: "Distribución por Efectividad Recaudación Predial", width: 300, description: "CER*50%" },
    { field: "A1_2",                        headerName: "Distribución por Población y Territorio",          width: 300, description: "CEPT*25%" },
  ...
  const columnsArticulo14f2: GridColDef[] = [
    ...
    { field: "Proyeccion", headerName: "Proyección de Póblación", width: 200, description: "PC" },
  ...
  useEffect(() => {
    loaddata(Number(params.tipo), String(params.id), String(params.activo), String(params.version));
