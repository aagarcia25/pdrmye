...
const CambiosMun = () => {
  ...
  const handlevalidar = (v: any) => {
    ...
    setLabelCatalogo(
      String(tablas.find(({ value }) => value == v.row.Tipo)?.label)
    );
  ...
  const acciones = (v: any) => {
    if (comentario) {
      Swal.fire({
        ...
        text:
          v == "autorizar" ? "¿Autorizara el cambio?" : "¿Rechazar el cambio?",
          ...
          <ModalForm
            title={
              String(solicitud?.deleted) == "1"
                ? "Solicitud de Borrado de Campo"
                : "Solicitud de Cambio de Valores"
            }
                  ...
                  <Card sx={{ minWidth: 275 }}>
                    <CardContent>
                      <Box>
                        ...
                        {origen?.CarenciaProm ? (
                          <Typography variant="h6">
                            {"Carencia Promedio: " + origen?.CarenciaProm}{" "}
                            <br />
                          </Typography>
                        ) : (
                          ""
                        ...
                        {origen?.Porcentaje ? (
                          <Typography variant="h6">
                            {"Porcentaje " + origen?.Porcentaje} <br />{" "}
                          </Typography>
                        ) : (
                          ""
                        )}
                        {origen?.ClaveBancaria ? (
                          <Typography variant="h6">
                            {"Clave Bancaria: " + origen?.ClaveBancaria} <br />{" "}
                          </Typography>
                        ) : (
                          ""
                        )}
                        ...
                        {origen?.Coeficiente ? (
                          <Typography variant="h6">
                            {"Coeficiente: " + origen?.Coeficiente} <br />{" "}
                          </Typography>
                        ) : (
                          ""
                        )}
                        ...
                        {origen?.totalPob ? (
                          <Typography variant="h6">
                            {"Población Total: " + origen?.totalPob} <br />{" "}
                          </Typography>
                        ) : (
                          ""
                        )}
                        {Number(origen?.Facturacion) >= 0 ? (
                          <Typography variant="h6">
                            {"Facturación: " + origen?.Facturacion} <br />{" "}
                          </Typography>
                        ) : (
                          ""
                        )}
                        ...
                        {origen?.Recaudacion ? (
                          <Typography variant="h6">
                            {"Recaudación: " + origen?.Recaudacion} <br />{" "}
                          </Typography>
                        ) : (
                          ""
                        )}
                        ...
                        {origen?.Movimientos ? (
                          <Typography variant="h6">
                            {"Movimientos: " + origen?.Movimientos} <br />{" "}
                          </Typography>
                        ) : (
                          ""
                        )}
                      ...
                      <Card sx={{ minWidth: 275 }}>
                        <CardContent>
                          <Box>
                            ...
                            {solicitud?.Personas ? (
                              <Typography variant="h6">
                                {"Personas: " + solicitud?.Personas} <br />
                              </Typography>
                            ) : (
                              ""
                            )}
                            {solicitud?.CarenciaProm ? (
                              <Typography variant="h6">
                                {"Carencia Promedio: " +
                                  solicitud?.CarenciaProm}
                                <br />
                            ...
                            {solicitud?.Porcentaje ? (
                              <Typography variant="h6">
                                {"Porcentaje: " + solicitud?.Porcentaje} <br />
                              </Typography>
                            ) : (
                              ""
                            )}
                            {solicitud?.ClaveBancaria ? (
                              <Typography variant="h6">
                                {"Clave Bancaria: " + solicitud?.ClaveBancaria}{" "}
                                <br />
                              </Typography>
                            ) : (
                              ""
                            ...
                            {solicitud?.Importe ? (
                              <Typography variant="h6">
                                {"Importe: " + solicitud?.Importe} <br />
                              </Typography>
                            ) : (
                              ""
                            )}
                            {solicitud?.Coeficiente ? (
                              <Typography variant="h6">
                                {"Coeficiente: " + solicitud?.Coeficiente}{" "}
                                <br />
                              </Typography>
                            ) : (
                              ""
                            ...
                            {solicitud?.totalPob ? (
                              <Typography variant="h6">
                                {"Poblacion Total: " + solicitud?.totalPob}{" "}
                                <br />
                              </Typography>
                            ) : (
                              ""
                            )}
                            {Number(solicitud?.Facturacion) >= 0 ? (
                              <Typography variant="h6">
                            ...
                            {solicitud?.Pob ? (
                              <Typography variant="h6">
                                {"Poblacion Total: " + solicitud?.Pob} <br />
                              </Typography>
                            ) : (
                              ""
                            )}
                            {solicitud?.Recaudacion ? (
                              <Typography variant="h6">
                                {"Recaudacion: " + solicitud?.Recaudacion}{" "}
                                <br />
                              </Typography>
                            ) : (
                              ""
                            ...
                            {solicitud?.Movimientos ? (
                              <Typography variant="h6">
                                {"Movimientos: " + solicitud?.Movimientos}{" "}
                                <br />
                              </Typography>
                            ) : (
                              ""
                        ...
                        title={
                          <>
                            {!comentario ? (
                              <React.Fragment>
                                <Typography
                                  color={comentario ? "inherit" : "error"}
                                >
                                  {comentario == "" ||
                                  comentario == null ||
                                  comentario?.trim() == ""
                  ...
                  >
                    ...
                    >
                      <Box>
                        <Button
                          disabled={
                            String(comentario).length == 0 ||
                            comentario == "" ||
                            comentario == null ||
                            comentario?.trim() == ""
                          }
                          className={"agregar"}
                          onClick={() => acciones("autorizar")}
                        >
                          Autorizar Solicitud
                        </Button>
                      </Box>
