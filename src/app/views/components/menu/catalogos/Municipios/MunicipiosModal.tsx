...
const MunFacturacionModal = ({
  ...
  const [checkedMam, setCheckedMam] = useState(
    dt?.row?.MAM == 1 ? true : false
  );
  const [checkedDescentralizado, setCheckedDescentralizado] = useState(
    dt?.row?.Descentralizado == 1 ? true : false
  );
  const [checkedArtF1, setCheckedArtF1] = useState(
    dt?.row?.ArtF1 == "1" ? true : false
  );
  const [checkedArtF2, setCheckedArtF2] = useState(
    dt?.row?.ArtF2 == "1" ? true : false
  );
  const [checkedArtF3, setCheckedArtF3] = useState(
    dt?.row?.ArtF3 == "1" ? true : false
  );
          ...
          >
            ...
            <Box component={Grid} item direction="row" xs={12} md={4}>
              <Box component={Grid} container direction="row" xs={12} md={12}>
                ...
                <Box component={Grid} item direction="row" xs={12} md={8}>
                  {" "}
                </Box>
                <Box component={Grid} item direction="row" xs={12} md={4}>
                  <button
