...
const AjustesCalculos = () => {
  ...
  return (
    <div style={{ height: 600, width: "100%" }}>
      <Title
        titulo={nombreMenu}
        tooltip={"Cátalogo para Agregar Ajustes a los Cálculos"}
      ></Title>
      <Grid
        container
        direction="row"
        ...
        >
          ...
          >
            <Grid item xs={3} sm={3} md={3} lg={3}>
              <Typography>Descripción de Ajustes de Cálculo:</Typography>
            </Grid>
            ...
            <Grid item xs={3} sm={3} md={3} lg={3}>
              <Typography>Valor de Keys Para Ajustes de Cálculo:</Typography>
            </Grid>
            <Grid item xs={9} sm={9} md={9} lg={9}>
              <TextField
                required
