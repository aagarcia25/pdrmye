...
const AuthSolicitudes = () => {
  ...
  const columnsParticipaciones = [
    ...
    { field: "a10", headerName: "Total",      width: 250,      description: "Total" ,...Moneda  },
    { field: "a11", headerName: "Retenciones",      width: 250,      description: "Retenciones" ,...Moneda  },
    { field: "a12", headerName: "Descuentos",      width: 250,      description: "Descuentos"  ,...Moneda },
    { field: "a5",
